...
$scriptlang['myrepeats'] = array (
  'login_strike' => '密码错误次数过多，请在 15 分钟后再尝试切换。',
  ...
  'login_invalid' => '账号切换失败，请确认密码和安全提问，您还可以尝试 {loginperm} 次。',
  'login_password_invalid' => '账号切换失败，请确认密码是否正确。',
  'login_question_empty' => '请输入账号的安全提问以及正确的答案。',
  'login_question_invalid' => '安全提问选择错误，请重新输入。',
...
$templatelang['myrepeats'] = array (
  ...
  'delete_check' => '删?',
  'switch_title' => '请输入密码',
  'switch_tips' => '为保护账号安全，切换时需要输入目标账号密码',
  'confirm' => '确定',
