...
<!--{subtemplate home/spacecp_header}-->
		...
		<form method="post" autocomplete="off" action="home.php?mod=spacecp&ac=privacy&op=$operation" class="profile-form privacy-form">
			<input type="hidden" name="formhash" value="{FORMHASH}" />

		<!--{if $operation == 'base'}-->
			<p class="form-tip">{lang you_control_see_content}</p>
			<div class="form-section">
				<!--{if helper_access::check_module('friend')}-->
				<div class="form-row">
					<div class="form-label">{lang friend_list}</div>
				...
				<div class="form-row">
					<div class="form-label">{lang message_board}</div>
					<div class="form-field">
				...
				<!--{if helper_access::check_module('feed')}-->
				<div class="form-row">
					<div class="form-label">{lang personal_feed}</div>
					<div class="form-field">
				...
				<div class="form-row">
					<div class="form-label">{lang doing}</div>
					<div class="form-field">
				...
				<div class="form-row">
					<div class="form-label">{lang blog}</div>
					<div class="form-field">
				...
				<div class="form-row">
					<div class="form-label">{lang album}</div>
					<div class="form-field">
				...
				<div class="form-row">
					<div class="form-label">{lang share}</div>
					<div class="form-field">
			...
			<div class="form-submit">
				<button type="submit" name="privacysubmit" value="true" class="pn pnc"><strong>{lang save}</strong></button>
			</div>

		<!--{elseif $operation == 'feed'}-->
			<p class="form-tip">{lang system_depend_action_message}</p>
			<div class="form-section">
				<div class="form-row form-row-checklist">
					<div class="form-field">
						<label class="check-item"><input type="checkbox" class="pc" name="privacy[feed][doing]" value="1"$sels[feed][doing] />{lang doing}</label>
						<label class="check-item"><input type="checkbox" class="pc" name="privacy[feed][blog]" value="1"$sels[feed][blog] />{lang write_blog}</label>
						<label class="check-item"><input type="checkbox" class="pc" name="privacy[feed][upload]" value="1"$sels[feed][upload] />{lang upload_pic}</label>
						<label class="check-item"><input type="checkbox" class="pc" name="privacy[feed][share]" value="1"$sels[feed][share] />{lang add_share}</label>
						<label class="check-item"><input type="checkbox" class="pc" name="privacy[feed][friend]" value="1"$sels[feed][friend] />{lang friend_add}</label>
						<label class="check-item"><input type="checkbox" class="pc" name="privacy[feed][comment]" value="1"$sels[feed][comment] />{lang publish_comment_reply}</label>
						<label class="check-item"><input type="checkbox" class="pc" name="privacy[feed][show]" value="1"$sels[feed][show] />{lang bidding_rank}</label>
						<label class="check-item"><input type="checkbox" class="pc" name="privacy[feed][credit]" value="1"$sels[feed][credit] />{lang credit_consumption}</label>
						<label class="check-item"><input type="checkbox" class="pc" name="privacy[feed][invite]" value="1"$sels[feed][invite] />{lang invite_friend}</label>
						<label class="check-item"><input type="checkbox" class="pc" name="privacy[feed][task]" value="1"$sels[feed][task] />{lang complete_task}</label>
						<label class="check-item"><input type="checkbox" class="pc" name="privacy[feed][profile]" value="1"$sels[feed][profile] />{lang update_presonal_profile}</label>
						<label class="check-item"><input type="checkbox" class="pc" name="privacy[feed][click]" value="1"$sels[feed][click] />{lang pic_blog_position}</label>
						<label class="check-item"><input type="checkbox" class="pc" name="privacy[feed][newthread]" value="1"$sels[feed][newthread] />{lang forum_post}</label>
						<label class="check-item"><input type="checkbox" class="pc" name="privacy[feed][newreply]" value="1"$sels[feed][newreply] />{lang forum_reply}</label>
					</div>
				</div>
		...
		<!--{elseif $operation == 'other'}-->
			<p class="form-tip">{lang you_control_other_operation}</p>
			<div class="form-section">
				<!--{if helper_access::check_module('friend')}-->
				<div class="form-row">
					<div class="form-label">{lang add_friends}</div>
					<div class="form-field">
				...
				<div class="form-row">
					<div class="form-label">{lang add_follow}</div>
					<div class="form-field">
			...
			<div class="form-submit">
				<button type="submit" name="privacy3submit" value="true" class="pn pnc"><strong>{lang save}</strong></button>
			</div>
		...
		<!--{else}-->
			...
			<div class="privacy-section">
				<h3 class="form-section-title">{lang filtering_rules_title_1}</h3>
				<div class="form-section">
					<div class="form-row form-row-checklist">
						<div class="form-field">
							<!--{loop $groups $key $value}-->
							<label class="check-item"><input type="checkbox" class="pc" name="privacy[filter_gid][$key]" value="$key"{if isset($space['privacy']['filter_gid'][$key])} checked="checked"{/if} />$value</label>
							<!--{/loop}-->
						</div>
					</div>
				</div>
			...
			<div class="privacy-section">
				<h3 class="form-section-title">{lang filtering_rules_title_2}</h3>
				<div class="form-section">
					<!--{if $icons}-->
					<div class="form-row form-row-checklist">
						<div class="form-field">
					...
					<div class="form-row">
						<div class="form-field">
							<p class="d">{lang no_shield_feed_cat}</p>
						</div>
					</div>
					<!--{/if}-->
				</div>
			...
			<div class="privacy-section">
				<h3 class="form-section-title">{lang filtering_rules_title_3}</h3>
				<div class="form-section">
					<!--{if $types}-->
					<div class="form-row form-row-checklist">
						<div class="form-field">
