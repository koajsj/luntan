...
$_config['security']['error']['showerror']      = '0';	//是否在数据库或系统严重异常时显示错误详细信息，0=不显示(更安全)，1=显示详细信息(默认)，2=只显示错误本身
$_config['security']['error']['guessplugin']    = '0';	//是否在数据库或系统严重异常时猜测可能报错的插件，0=不猜测，1=猜测(默认)
...
$_config['admincp']['mustlogin']		= 1;		// 是否必须前台登录后才允许后台登录  1=是[安全] 0=否（如果前台已登录，后台的登录态不会同步到前台，前后台可登录2个账号）
